...
def read_training_log():
    ...
    log_filename = "dqnTrainLog_continue.txt"
...
def main():
    ...
    model = DQN.load("dqn_gradius_model")
    ...
    model.save("dqn_gradius_model_continue")
    print("Modelo continuado y guardado como 'dqn_gradius_model_continue'.")
