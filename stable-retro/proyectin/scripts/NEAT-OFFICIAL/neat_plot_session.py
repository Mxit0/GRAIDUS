...
# Cargar los datos de ambos entrenamientos (asegurate de que los archivos CSV estén correctos)
...
plt.ylabel("Puntaje")
plt.legend()
plt.title("Entrenamiento NEAT de GradiusIII-Snes")
plt.grid(True)

# Guardar la gráfica
plt.savefig("training_comparison_neat.png")
plt.show()
