...
def read_training_log():
    ...
    log_filename = "a2cTrainLog_continue.txt"
...
def main():
    ...
    model = A2C.load("a2c_gradius_model")
    ...
    model.save("a2c_gradius_model_continue")
    print("Modelo continuado y guardado como 'a2c_gradius_model_continue'.")
